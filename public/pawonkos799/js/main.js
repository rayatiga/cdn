...
if (navBarMenu) {
    ...
    function navBar() {
        navBarMenu.innerHTML = `
            <div class="container">
                <a class="navbar-brand" href="/"><img src="https://cdn.rayatiga.com/pawonkos799/media/nav-logo.png" alt="Pawonkos799" width="45" /></a>
    ...
    footerBottom.innerHTML = `
            <div class="container py-4">
                <div class="row row-cols-1 row-cols-lg-3 g-4">
                    <div class="col"><img src="https://cdn.rayatiga.com/pawonkos799/media/pawonkos799-big-favicon.png" alt="Pawonkos799" width="50" /><span class="d-block fw-semibold fs-4">Pawonkos799</span><span class="d-block">Produk Pawonkos ini sangat mengedepankan cita rasa Nusantara. Semua Produk kami adalah produk handmade by order dan bergaransi.</span></div>
                    <div class="col"><span class="d-block fw-semibold fs-4">Pembelian Produk</span><img src="https://cdn.rayatiga.com/pawonkos799/media/shopee-logo.png" alt="Bank Central Asia" width="75" class="d-block mt-2 mb-3" /><span class="fw-semibold">Checkout via Shopee</span><span class="d-block">Mulai 15 April 2023, seluruh pembelian dan transaksi dilakukan melalui Shopee (@pawonkos799).</span></div>
                    <div class="col">
